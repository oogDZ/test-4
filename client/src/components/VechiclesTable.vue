...
export default {
  ...
  methods: {
    ...
    deleteItemConfirm() {
      console.log(this.vechicles);
      this.vechicles.splice(this.editedIndex, 1);
    ...
    save() {
      if (this.editedIndex > -1) {
        ...
        console.log(this.vNexstId);
        //const crypto = require("crypto");

        this.editedItem.id = uuid.v1(); //crypto.randomUUID();
        console.log(this.editedItem.id);
        // this.vechicles.push(this.editedItem);
        // this.vNexstId = this.vNexstId + 1;
        //console.log("tgkdfjgklndsfjlnkndfkjgnkldjfn" + Vechicle);
      }
      this.socket.emit("setVechicles", { data: this.vechicles });
      this.close();
    },
